...
categories: [tech]
tags: [blog]
published: 2019-12-06 23:30:18
---
晚上顺手去阿里云申请了 SSL 证书，把 `wuyuying.com` 从 `http` 到 `https`。  
## SSL 模块 for Nginx
环境：  
* CentOS
* Nginx
...
```
## 附录
* [Centos7 配置 https，及多个 https 配置](https://www.cnblogs.com/sxshaolong/p/10186334.html)
